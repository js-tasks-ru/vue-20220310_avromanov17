    ...
    <div class="agenda-item-form__row">
      <div class="agenda-item-form__col">
        <ui-form-group label="Начало">
          <ui-input v-model="currentStartTime" type="time" placeholder="00:00" name="startsAt" />
        </ui-form-group>
      </div>
      <div class="agenda-item-form__col">
...
export default {
  ...
  data() {
    return {
      ...
      currentStartTime: this.agendaItem.startsAt,
    };
  },
  ...
  watch: {
    ...
    currentStartTime(newValue, prevValue) {
      this.localAgendaItem.startsAt = newValue;
      const currentStartTime = moment(prevValue, 'HH:mm');
      const newStartTime = moment(newValue, 'HH:mm');
      const timeDiffMinutes = newStartTime.diff(currentStartTime, 'minutes');
      this.localAgendaItem.endsAt = moment(this.localAgendaItem.endsAt, 'HH:mm')
